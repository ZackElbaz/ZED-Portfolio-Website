...
//         setIsOpen(!isOpen);
//         setSearchInput('');
//         setFilteredProjectList(ProjectList); // Reset filtered Project when opening the dropdown
...
//         } else {
//             const filtered = ProjectList.filter(ProjectList => ProjectList.name.toLowerCase().includes(inputValue.toLowerCase()));
...
//                         <ul>
//                             {filteredProjectList.map((ProjectList, idx) => (
//                                 <li
//                                     key={ProjectList.id}
//                                     style={{
//                                         cursor: 'pointer',
//                                         backgroundProjectList: idx === selectedIdx || (selectedIdx === -1 && idx === 0) ? '#ccc' : 'transparent', // Highlight the selected Project or the top option
//                                     }}
